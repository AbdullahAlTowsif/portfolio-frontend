...
const HomeCarousel = () => {
  return (
    <div className="w-full max-w-7xl mx-auto pt-20 md:pt-36 pb-10 px-2 sm:px-4">
      <div className="carousel w-full rounded-xl shadow-lg overflow-hidden">
        ...
        <div id="slide1" className="carousel-item relative w-full">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center text-white px-3 sm:px-6">
            <h2 className="text-xl sm:text-3xl md:text-5xl font-bold mb-2 sm:mb-4">
              Welcome to My Blogs
            </h2>
            <p className="max-w-xs sm:max-w-md md:max-w-xl text-sm sm:text-base mb-4 sm:mb-6">
              Explore insightful blogs, learn new skills, and stay inspired with fresh ideas.
            </p>
            <Button size="sm" className="sm:size-md md:size-lg" asChild>
        ...
        <div id="slide2" className="carousel-item relative w-full">
          ...
          <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center text-white px-3 sm:px-6">
            ...
            <Button size="sm" variant="secondary" className="sm:size-md md:size-lg" asChild>
